...
def validate_sdist(sdist_path: Path) -> None:
    with tarfile.open(sdist_path, mode="r:gz") as archive:
        ...
        required = {
            ...
            f"{expected_root}/visual_copy_contract.py",
            ...
            f"{expected_root}/vex_visuals/frame_sampling.py",
            f"{expected_root}/vex_visuals/open_visual_program.py",
            f"{expected_root}/vex_visuals/portfolio.py",
            f"{expected_root}/vex_visuals/repair.py",
            f"{expected_root}/vex_visuals/temporal_proof.py",
